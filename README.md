# 🔐 CipherVault - Secure Password Generator
...
- **🛡️ Entropy Control**: Precision length adjustment from 8 to 64 characters to meet any security requirement.
- **⚙️ Protocol Customization**: Granular control over character sets, including uppercase, lowercase, numeric, and symbolic parameters.
...
- **⚛️ Frontend**: React 19 for efficient component-based UI rendering.
...
<p align="center">
  Developed with 💚 by <a href="https://github.com/heyaryanmittal">Aryan Mittal</a>
</p>
